		       ...
		       text: "学生住宿管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Live/live_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生住宿查询",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Live/live_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "报修信息管理",
			       ...
			       children:
			    	   [{
			    	   	...
			    	   	},
			    		{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "RepairItem/repairItem_add.jsp"
			    	   	},
			    		{
			    	   		text: "报修项目管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "RepairItem/repairItem_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加报修状态",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "RepairState/repairState_add.jsp"
			    	   	},
			    		{
			    	   		text: "报修状态管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "RepairState/repairState_query_result.jsp"
			    	    }
