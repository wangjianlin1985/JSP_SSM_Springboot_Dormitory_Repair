...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">宿舍报修管理网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Building/frontlist">宿舍楼查询</a></li>
                <li><a href="<%=basePath %>Room/frontlist">宿舍查询</a></li>
                <li><a href="<%=basePath %>Live/frontlist">住宿查询</a></li>
                <li><a href="<%=basePath %>Repair/frontlist">报修列表</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Live/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的住宿查询</a></li>
                        <li><a href="<%=basePath %>Repair/repair_frontStudentAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要报修</a></li>
                        <li><a href="<%=basePath %>Repair/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的报修列表</a></li>
