...
<%
    ...
    String speicalName = (String)request.getAttribute("speicalName"); //所在专业查询关键字
    String gradeInfo = (String)request.getAttribute("gradeInfo"); //年级查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Student/<%=student.getStudentNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=student.getStudentPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在专业:<%=student.getSpeicalName() %>
			     	</div>
			     	<div class="field">
	            		年级:<%=student.getGradeInfo() %>
			     	</div>
			     	<div class="field">
	            		姓名:<%=student.getName() %>
			     	</div>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="studentQueryForm" id="studentQueryForm" action="<%=basePath %>Student/frontlist" class="mar_t15">
			...
			<div class="form-group">
				<label for="speicalName">所在专业:</label>
				<input type="text" id="speicalName" name="speicalName" value="<%=speicalName %>" class="form-control" placeholder="请输入所在专业">
			</div>
			<div class="form-group">
				<label for="gradeInfo">年级:</label>
				<input type="text" id="gradeInfo" name="gradeInfo" value="<%=gradeInfo %>" class="form-control" placeholder="请输入年级">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="student_speicalName_edit" class="col-md-3 text-right">所在专业:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="student_speicalName_edit" name="student.speicalName" class="form-control" placeholder="请输入所在专业">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="student_gradeInfo_edit" class="col-md-3 text-right">年级:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="student_gradeInfo_edit" name="student.gradeInfo" class="form-control" placeholder="请输入年级">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (student, response, status) {
			if (student) {
				...
				$("#student_speicalName_edit").val(student.speicalName);
				$("#student_gradeInfo_edit").val(student.gradeInfo);
