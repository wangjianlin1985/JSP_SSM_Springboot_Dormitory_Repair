...
public class StudentService {
    ...
    /*按照查询条件分页查询学生记录*/
    public ArrayList<Student> queryStudent(String studentNo,String speicalName,String gradeInfo,String name,String birthDate,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!studentNo.equals("")) where = where + " and t_student.studentNo like '%" + studentNo + "%'";
    	if(!speicalName.equals("")) where = where + " and t_student.speicalName like '%" + speicalName + "%'";
    	if(!gradeInfo.equals("")) where = where + " and t_student.gradeInfo like '%" + gradeInfo + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String studentNo,String speicalName,String gradeInfo,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!studentNo.equals("")) where = where + " and t_student.studentNo like '%" + studentNo + "%'";
    	if(!speicalName.equals("")) where = where + " and t_student.speicalName like '%" + speicalName + "%'";
    	if(!gradeInfo.equals("")) where = where + " and t_student.gradeInfo like '%" + gradeInfo + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String studentNo,String speicalName,String gradeInfo,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!studentNo.equals("")) where = where + " and t_student.studentNo like '%" + studentNo + "%'";
    	if(!speicalName.equals("")) where = where + " and t_student.speicalName like '%" + speicalName + "%'";
    	if(!gradeInfo.equals("")) where = where + " and t_student.gradeInfo like '%" + gradeInfo + "%'";
